...
async def start_handler(message: Message) -> None:
    await message.answer(
        "Слава Ісусу Христу! 🙏\n\n"
        "📖 <b>GodSearchBot</b> допомагає читати щоденні "
        "літургійні читання Мукачівської греко-католицької "
        "єпархії.\n\n"
        "Тут ви можете:\n"
        "• переглянути читання на сьогодні або іншу дату;\n"
        "• відкрити повний текст Святого Письма;\n"
        "• шукати слова та фрази в Біблії;\n"
        "• зберігати читання в обране;\n"
        "• підписатися на щоденну розсилку о 07:00.\n\n"
        "Оберіть потрібну кнопку нижче або надішліть дату "
        "у форматі 31.10.2026.",
        parse_mode="HTML",
